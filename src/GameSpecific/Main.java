...
public class Main extends LevelWL {
   /*Need for level
    ...
    public Main(){
        ...
        ActorBox w14 = buildWall(0,0,0, 1, 20, 20);
        ...
        ActorBox w15 = buildWall(0,0,0, 1, 20, 20);
        ...
        ActorBox w16 = buildWall(0,0,0, 1, 20, 20);
        ...
        ActorBox w17 = buildWall(0,0,0, 1, 20, 15);
        ...
        ActorBox w18 = buildWall(0,0,0, 1, 20, 15);
        w18.setTranslateZ(210);
        w18.setTranslateX(20);
        getChildren().add(w18);

        ActorBox w19 = buildWall(0,0,0, 1, 20, 20);
        ...
        ActorBox w20 = buildWall(0,0,0, 1, 20, 20);
        ...
        ActorBox w21 = buildWall(0,0,0, 1, 20, 20);
        w21.setTranslateZ(170);
        w21.setTranslateX(5);
        getChildren().add(w21);

        ActorBox w22 = buildWall(0,0,0, 1, 20, 20);
        w22.setTranslateZ(170);
        w22.setTranslateX(-5);
        getChildren().add(w22);

        ActorBox w23 = buildWall(0,0,0, 1, 20, 20);
        ...
        ActorBox w24 = buildWall(0,0,0, 1, 20, 20);
