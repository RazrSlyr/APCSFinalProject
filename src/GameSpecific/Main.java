...
public class Main extends LevelWL {
   /*Need for level
    ...
    public Main(Text text){
        ...
        // Walls
        ActorBox w1 = buildWall(0, 0, 0, 4, 30, 20);
        w1.setTranslateZ(-200);
        w1.setTranslateX(10);
        getChildren().add(w1);

        ActorBox w2 = buildWall(0, 0, 0, 4, 30, 20);
        w2.setTranslateZ(-200);
        w2.setTranslateX(-10);
        getChildren().add(w2);

        ActorBox w3 = buildWall(0, 0, 0, 4, 30, 20);
        ActorBox w4 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w5 = buildWall(0, 0, 0, 4, 30, 20);
        ActorBox w6 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w7 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w10 = buildWall(0, 0, 0, 4, 30, 20);
        w10.setTranslateZ(-120);
        w10.setTranslateX(30);
        getChildren().add(w10);

        ActorBox w11 = buildWall(0, 0, 0, 4, 30, 20);
        w11.setTranslateZ(-120);
        w11.setTranslateX(20);
        getChildren().add(w11);

        ActorBox w13 = buildWall(0, 0, 0, 4, 30, 20);
        w13.setTranslateZ(-120);
        w13.setTranslateX(-20);
        getChildren().add(w13);

        ActorBox w14 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w15 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w16 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w17 = buildWall(0, 0, 0, 4, 30, 15);
        ...
        ActorBox w18 = buildWall(0, 0, 0, 4, 30, 15);
        w18.setTranslateZ(210 - 210);
        w18.setTranslateX(20);
        getChildren().add(w18);

        ActorBox w19 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w20 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w21 = buildWall(0, 0, 0, 4, 30, 20);
        w21.setTranslateZ(170 - 210);
        w21.setTranslateX(5);
        getChildren().add(w21);

        ActorBox w22 = buildWall(0, 0, 0, 4, 30, 20);
        w22.setTranslateZ(170 - 210);
        w22.setTranslateX(-5);
        getChildren().add(w22);

        ActorBox w23 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w24 = buildWall(0, 0, 0, 4, 30, 20);
        w24.setTranslateZ(150 - 210);
        w24.setTranslateX(20);
        getChildren().add(w24);

        ActorBox w25 = buildWall(0, 0, 0, 4, 30, 20);
        w25.setTranslateZ(190 - 210);
        w25.setTranslateX(-20);
        getChildren().add(w25);

        ActorBox w26 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w27 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w28 = buildWall(0, 0, 0, 4, 30, 20);
        w28.setTranslateZ(110 - 210);
        w28.setTranslateX(-20);
        getChildren().add(w28);

        ActorBox w29 = buildWall(0, 0, 0, 4, 30, 20);
        w29.setTranslateZ(110 - 210);
        w29.setTranslateX(-10);
        getChildren().add(w29);

        ActorBox w30 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w31 = buildWall(0, 0, 0, 4, 30, 20);
        ...
        ActorBox w32 = buildWall(0, 0, 0, 4, 30, 20);
        w32.setTranslateZ(150 - 210);
        w32.setTranslateX(30);
        getChildren().add(w32);

        ActorBox w33 = buildWall(0, 0, 0, 4, 30, 10);
        w33.setTranslateZ(136 - 210);
        w33.setTranslateX(0);
        getChildren().add(w33);

        ActorBox w34 = buildWall(0, 0, 0, 4, 30, 15);
...
//        timeElapsedText.setText("Time elapsed: " + (timeElapsed/1000));
    ...
    private ActorBox buildFloor() {
        ...
        floor.setMaterial(new PhongMaterial(Color.DARKORANGE));
